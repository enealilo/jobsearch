      ...
      <div className="w-full h-[536px] px-[15px] bg-white justify-start items-center inline-flex">
        <div className="grow shrink basis-0 self-stretch relative">
          <div className="w-[300.43px] h-[536px] left-0 top-0 absolute rounded-bl-[250px] rounded-br-[250px] flex-col justify-end items-center gap-2.5 inline-flex">
            <img
              className="w-[295px] h-[295px] rounded-[250px]"
              src="/handshake.jpg"
            />
          </div>
          <div className="w-full h-[391px] left-[300px] top-0 absolute bg-[#f1f4f8] rounded-br-[7px]">
            ...
            <div className="w-[743px] left-[182.79px] top-[173px] absolute text-fuchsia-800 text-lg font-normal font-['Inter'] leading-7">
              ...
              seamless and efficient connection that propels the tech industry
              forward.{" "}
            </div>
            <div className="py-2.5 left-[182.79px] top-[302px] absolute justify-start items-center gap-2.5 inline-flex">
      ...
      <div className="w-full h-[566px] px-[15px] bg-white justify-start items-center inline-flex">
        <div className="w-[894px] h-[393px] px-[30px] py-2.5 flex-col justify-center items-start gap-2.5 inline-flex">
          ...
          <div className="self-stretch text-black text-lg font-light font-['Inter'] leading-7">
            ...
            drive innovation, and we are committed to facilitating those
            transformative connections. What Sets Us Apart Precision Matching:
            Our advanced algorithms and machine learning capabilities ensure
            precise job matches, considering not only skills and experience but
            also cultural fit and career aspirations. Comprehensive Tech
            Spectrum: Whether you are a seasoned software engineer, a
            cybersecurity expert, a data scientist, or exploring emerging tech
            fields, covers a broad spectrum of technology roles across
            industries. User-Centric Design: Navigating the job market can be
            overwhelming. Our user-friendly interface simplifies the process,
            providing an intuitive and enjoyable experience for both job seekers
            and employers. Industry Insights: Stay ahead of the curve with our
            curated content, featuring industry trends, career advice, and
            insights from tech leaders. We believe that informed professionals
            make better career decisions.
          </div>
        </div>
        <div className="grow shrink basis-0 rounded-[400px] flex-col justify-center items-center gap-2.5 inline-flex">
          <div className="w-[503px] h-[566px] relative">
            <div className="w-[379.56px] h-[380.53px] left-[124.01px] top-0 absolute bg-[#2a68ff] rounded-full"></div>
            <img
              className="w-[475.66px] h-[475.66px] left-0 top-[71.84px] absolute rounded-[500px] shadow border-4 bg-[#2a68ff]"
              src="/digital.jpg"
            />
          </div>
        </div>
        ...
        <div className="w-[620px] self-stretch justify-start items-start gap-2.5 inline-flex">
          <div className="w-[284px] h-[604px] px-[34px] flex-col justify-center items-center gap-5 inline-flex">
            <div className="w-[250px] h-[291px] relative">
              <img
                className="w-[250px] h-[250px] left-0 top-0 absolute rounded-[250px] border-4 border-[#AED6F1]"
                src="/rudina.jpg"
              />
              <div className="p-[5px] left-0 top-[111px] absolute opacity-90 bg-[#AED6F1] rounded-[5px] justify-center items-center gap-2.5 inline-flex">
                <div className="text-center text-black text-base font-light font-['Inter']">
                  Rudina Himallari
                </div>
              </div>
            </div>
            <div className="w-[250px] h-[291px] relative">
              <img
                ...
                src="/enea.JPG"
              />
              <div className="px-2.5 py-[5px] left-0 top-[111px] absolute opacity-90 bg-[#AED6F1] rounded-[5px] justify-center items-center gap-2.5 inline-flex">
                <div className="text-center text-black text-base font-light font-['Inter']">
                  Enea Lilo
                </div>
              </div>
          ...
          <div className="w-[323px] px-2.5 justify-start items-center gap-2.5 flex">
            <div className="w-[303px] h-96 relative">
              <div className="w-[273px] h-[273px] left-[15px] top-[29px] absolute rounded-full shadow" />
              <div className="w-[250px] h-[251px] left-0 top-[80px] absolute">
                <img
                  className="w-[250px] h-[250px] left-0 top-[0.50px] absolute rounded-[250px] border-4 border-[#AED6F1]"
                  src="/amine.jpg"
                />
                <div className="px-2.5 py-[5px] left-0 top-[111px] absolute opacity-90 bg-[#AED6F1] rounded-[5px] justify-center items-center gap-2.5 inline-flex">
                  <div className="text-center text- text-base font-light font-['Inter']">
                    Amine Keta
                  </div>
                </div>
              </div>
          ...
          <div className="self-stretch px-[15px] justify-start items-center gap-2.5 inline-flex">
            <div className="grow shrink basis-0 self-stretch">
              ...
              {" "}Experienced web developer adept at translating creative concepts
                ...
                keen eye for detail, I ensure cross-browser compatibility and
                optimal performance for a seamless user experience. My
                collaborative approach involves working closely with design and
                backend teams to deliver cohesive and scalable solutions.
                Committed to staying abreast of industry trends, I bring a
              ...
              {" "}  As a web developer, I specialize in transforming ideas into
                ...
                efficient code ensures optimal website performance and easy
                maintenance. Experienced in collaborating with diverse teams, I
                bring a collaborative and communicative approach to every
                project. Constantly evolving with the evolving web landscape, I
                stay updated on the latest technologies to deliver cutting-edge
                solutions.
                <br />
                <br />
              </span>
