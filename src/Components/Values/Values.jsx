      ...
      <div className="grid gap-[160px] grid-cols-3 items-center">
        <div className="singleGrid rounded-[10px] p-[24px] hover:bg-[#eeedf7]">
          ...
          <p className="text-[13px] text-[252b36] opacity-[0.7] py-[16px] font-semibold">
            Inspirational leaders understand that they set the tone for the
            entire organization. They lead by example, embodying the values and
            behaviors they expect from their teams. When leaders exhibit
            integrity, dedication, and a strong work ethic, it becomes
            contagious, inspiring employees to follow suit.
          </p>
        </div>
        ...
        <div className="singleGrid rounded-[10px] p-[24px] hover:bg-[#eeedf7]">
          ...
          <p className="text-[13px] text-[252b36] opacity-[0.7] py-[16px] font-semibold">
            Inspirational leaders recognize the importance of giving their
            employees autonomy and trusting them to make decisions. When
            employees feel empowered and trusted, they are more likely to take
            ownership of their work, innovate, and contribute positively to the
            company culture.
          </p>
        </div>
        ...
        <div className="singleGrid rounded-[10px] p-[24px] hover:bg-[#eeedf7]">
          ...
          <p className="text-[13px] text-[252b36] opacity-[0.7] py-[16px] font-semibold">
            Inclusive leaders understand that diversity in thought, background,
            and experience can lead to innovation and creativity. They actively
            promote diversity and inclusion within their organizations,
            fostering a culture where every employee feels valued and respected.
          </p>
        </div>
      </div>
