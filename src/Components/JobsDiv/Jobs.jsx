      ...
      <div className="jobContainer flex gap-10 justify-center flex-wrap items-center py-10">
        {
          ...
          <span className="flex justify-between items-center gap-4">
            <h1 className="text-[16px] font-semibold text-[#252b36] group-hover:text-white">{title}</h1>
          ...
          <p className='text-[13px] text-[#959595] border-t-[2px] mt-[20px] group-hover:text-white'>{desc}</p>
